...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserRepository userRepository, RoleRepository roleRepository, StorageService storageService) {
    ...
    public UserResponseDTO saveUser(UserRequestDTO userRequest) {
        ...
        UserInfo oldUser = getCurrentUserInfo();
        if(oldUser != null){
    ...
    public List<UserResponseDTO> getAllUser() {
        List<UserInfo> users = (List<UserInfo>) userRepository.findAllById(new HashSet<>(Arrays.asList(getCurrentUserInfo().getId())));
